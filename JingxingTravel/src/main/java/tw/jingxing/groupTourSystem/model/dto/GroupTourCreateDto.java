...
public class GroupTourCreateDto {
	...
	public String toString() {
		return "GroupTourCreateDto [itineraryName=" + itineraryName + ", itineraryImage=" + itineraryImage
				...
				+ ", featureImage2=" + featureImage2 + ", featureImage2Base64=" + featureImage2Base64
				+ ", featureImage3=" + featureImage3 + ", featureImage3Base64=" + featureImage3Base64 + ", feature1="
				+ feature1 + ", feature2=" + feature2 + ", feature3=" + feature3 + ", itineraryContent="
				+ itineraryContent + ", seatCapacity=" + seatCapacity + ", departureDate="
				+ departureDate + ", departureTransport=" + departureTransport + ", returnDate=" + returnDate
				+ ", returnTransport=" + returnTransport + ", price=" + price + ", note=" + note + "]";
	}
