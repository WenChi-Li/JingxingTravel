package tw.jingxing.groupTourSystem.controller;
...
import tw.jingxing.groupTourSystem.model.dto.GroupTourCreateDto;
import tw.jingxing.groupTourSystem.model.dto.GroupTourUpdateDto;
import tw.jingxing.groupTourSystem.model.service.GroupTourService;
...
//		try {
			...
			bean.setFeatureImage3(dto.getFeatureImage3Base64());
			bean.setFeature1(dto.getFeature1());
			bean.setFeature2(dto.getFeature2());
			bean.setFeature3(dto.getFeature3());
...
//		}
		return new RedirectView("http://localhost:8080/html/ShowGroupTour.html");
	}
